          ...
          items: [
            "core-systems/action-handler/overview",
            {
              ...
              items: [
                ...
                "core-systems/action-handler/actions/acknowledge-session-video",
                "core-systems/action-handler/actions/start-break",
                "core-systems/action-handler/actions/end-break",
              ],
            },
          ],
        },
