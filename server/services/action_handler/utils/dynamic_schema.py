...
ACTION_TYPE_TO_MODEL: Dict[ActionType, Type[BaseModel]] = {
    ...
    ActionType.SHOW_SUGGEST_I_AM_STATEMENT_COMPONENT: ShowSuggestIAMStatementComponentAction,
    ActionType.SHOW_I_AM_STATEMENTS_SUMMARY_COMPONENT: ShowIAmStatementsSummaryComponentAction,
    ...
    ActionType.PERSIST_SUGGEST_I_AM_STATEMENT_COMPONENT: PersistSuggestIAMStatementComponentAction,
    ActionType.PERSIST_I_AM_STATEMENTS_SUMMARY_COMPONENT: PersistIAmStatementsSummaryComponentAction,
