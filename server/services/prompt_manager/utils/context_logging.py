...
def log_context_stats(prompt_context: PromptContext):
    ...
    # 3. Log num_identities
    log.debug(
        f"NUMBER_OF_IDENTITIES: {getattr(prompt_context, 'num_identities', None)}"
    )
    # 4. Log current_identity_description
    log.debug(
