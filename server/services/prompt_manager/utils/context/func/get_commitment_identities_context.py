...
from services.prompt_manager.utils.format_identities_needing_commitment import (
    format_identities_needing_commitment,
)
...
def get_commitment_identities_context(coach_state: CoachState) -> str:
    ...
    identities: List[Identity] = (
        user.identities.exclude(state=IdentityState.COMMITMENT_COMPLETE)
