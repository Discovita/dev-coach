...
import { Eye, Search, Loader2, FlaskConical } from "lucide-react";
              ...
              return (
                <tr
                  ...
                  className={`hover:bg-muted/30 transition-colors ${
                    isCurrentlyImpersonating ? "bg-amber-50 dark:bg-amber-950/30" : ""
                  }`}
                >
                  ...
                  <td className="px-4 py-3 hidden md:table-cell">
                    {user.is_test_user ? (
                      ...
                      <span className="text-xs text-muted-foreground">Real user</span>
                    )}
                  </td>
                  <td className="px-4 py-3 hidden md:table-cell">
                    {user.coaching_phase ? (
