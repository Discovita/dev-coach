...
export const jasonImages: IdentityImage[] = [
  { baseName: "financial_alchemist", title: filenameToTitle("financial_alchemist") },
  { baseName: "tactical_mastermind", title: filenameToTitle("tactical_mastermind") },
  { baseName: "financial_brick_mason", title: filenameToTitle("financial_brick_mason") },
  ...
  { baseName: "manifestation_king", title: filenameToTitle("manifestation_king") },
...
export const latrizaImages: IdentityImage[] = [
  ...
  { baseName: "beautiful_goddess", title: filenameToTitle("beautiful_goddess") },
  { baseName: "grounded_mother", title: filenameToTitle("grounded_mother") },
  { baseName: "money_lover", title: filenameToTitle("money_lover") },
  { baseName: "captain_of_my_life", title: filenameToTitle("captain_of_my_life") },
  { baseName: "open_hearted_lover", title: filenameToTitle("open_hearted_lover") },
  { baseName: "talented_innovator", title: filenameToTitle("talented_innovator") },
...
export const leighAnnImages: IdentityImage[] = [
  ...
  { baseName: "successful_entrepenuer", title: filenameToTitle("successful_entrepenuer") },
