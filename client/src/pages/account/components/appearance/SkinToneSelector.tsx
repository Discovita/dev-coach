import {
	SKIN_TONE_COLORS,
	SKIN_TONE_DISPLAY_NAMES,
	SkinTone,
} from "@/enums/appearance/skinTone";
				...
				{tones.map((tone) => (
					<button
						...
						className={`w-10 h-10 rounded-full transition-all border-2 cursor-pointer ${
							value === tone.value
								? "border-[var(--nv-royal-purple)] ring-2 ring-[var(--nv-royal-purple)] ring-offset-2"
								: "border-transparent hover:border-[var(--nv-pale-lavender)]"
						}`}
