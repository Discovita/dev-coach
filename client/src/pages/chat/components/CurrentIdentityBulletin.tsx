  ...
  return (
    <div className="relative px-6 py-2">
      ...
      <div className="pr-20">
        ...
        <div className="mb-4">
          <h3
            className={`font-bold text-lg mb-1 ${colorClasses} bg-transparent`}
          >
            {identity.name}
          </h3>
        ...
        {identity.i_am_statement && (
          <div className="mb-4">
            <p
              className={`text-sm font-semibold mb-2 ${colorClasses} bg-transparent`}
            >
              I Am Statement:
            </p>
...
export const CurrentIdentityBulletin: React.FC<{
  ...
  const lightColorClasses = getIdentityCategoryLightColor(
    String(currentIdentity.category)
  );
