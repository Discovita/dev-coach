 ...
 */
export const WarmupBulletin: React.FC<{
	coachState: CoachState | null | undefined;
}> = ({ coachState }) => {
		...
		<div className="mb-3 p-3 bg-gold-100 dark:bg-neutral-800 border border-gold-400 rounded-md">
			<div className="flex justify-between gap-4">
				<div className="flex-1">
					<div className="text-xs font-semibold text-gold-800 dark:text-gold-200 mb-1">
						Who You Are
					</div>
					{coachState?.who_you_are && coachState.who_you_are.length > 0 ? (
						<p className="text-xs text-neutral-800 dark:text-neutral-200 break-words">
