...
export default function TestScenarioChatMessagesForm({
	value,
	onChange,
}: Props) {
	const parentRef = useRef<HTMLDivElement>(null);
	const [draft, setDraft] = useState<TestScenarioChatMessage>({
		role: "user",
		content: "",
	});
			...
			>
				{value.map((msg, idx) => (
					...
					>
						...
						<div className="flex-1 whitespace-pre-wrap break-words leading-[1.5] py-0.5">
							{msg.content}
						</div>
						<Button
							type="button"
